...
{/* ///////////////////////// Rameshwaram ///////////////////////////////// */ }
      <section className='mt-5 pt-1 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("../img/rameshwarem1.jpeg")}
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/rameshwarem2.jpeg")}
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/rameshwarem1 (6).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/Rameshwaram3..jpeg")}
...
{/* //////////////////////// kodaikanal //////////////////////////////////// */}
      <section className='mt-5 pt-1 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("../img/kodaikanal1....jpeg")}
            alt="Green Valley"
            className='im5'>
          </img> 
          <span className='ms-4 me-3 disttext '>
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kodaikanal2.jpeg")}
            alt="Kodai Lake"
            className='im4'>
          </img>
        </div>
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/kodaikanal3..jpeg")}
      ...
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kodaikanal4.jpeg")}
            alt="Pillar Rockse"
            className='im3'>
          </img>
        </div>
...
{/* //////////////////////// Kanyakumari //////////////////////////////// */}
      <section className='mt-5 pt-1 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("../img/kanyakumari1 (1).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kanyakumari1.(2).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/kanyakumari1.(3).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kanyakumari1 (4).jpeg")}
...
{/* ////////////////////////// kumbakonam1 ///////////////////////////////// */}
      <section className='mt-5 pt-1 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("../img/kumbakonam1 (1).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kumbakonam1 (2).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/kumbakonam1 (3).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/kumbakonam1 (4).jpeg")}
...
are persevered in this orchidarium which is ranked the third largest of all the orchidariums in India
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/yercaud1 (2).jpeg")}
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/yercaud1.(3).jpeg")}
            alt="Emerald lake"
            className='im5'>
          </img>
          <span className='ms-4 me-3 disttext '>
...
reflected in its waters
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/yercaud1.(4).jpeg")}
            alt="lady's Seat"
            className='im9'>
          </img>
        </div>
...
{/* ///////////////////// Hogenakkal ///////////////////////////////// */ }
      <section className='mt-5 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("../img/hogenakkal1.jpeg")}
...
medicinal properties, owing to the numerous herbs that grow in its path. Known for its pristine appeal.
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/hogenakkal2..jpeg")}
            alt="falls"
            className='im9'>
          </img>
        </div>
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("../img/hogenakkal3.jpeg")}
...
land around it. Another major attraction of the area is a water reservoir flanked by hilly ranges all around.
          ...
          <img 
            style={{ width: '20%' }}
            src={require("../img/hokenakkal4..jpeg")}
            alt="view"
            className='im9'>
          </img>
        </div>
